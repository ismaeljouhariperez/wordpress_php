<div class="row mx-auto pt-5 pb-4">
    <div class="col-12 text-center">
        <img class="main-logo" src="http://localhost/wp-content/themes/ninetyninetyone/assets/images/Logo-Offshore.svg" alt="">
...
<article id="post-<?php $the_query->the_ID(); ?>" class="article article-has-backgroundThumb">
